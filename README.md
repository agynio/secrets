...
Secrets service for managing secret providers and resolving secrets.

Architecture: [Secrets](https://github.com/agynio/architecture/blob/main/architecture/secrets.md)
